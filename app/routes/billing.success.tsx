...
export function meta() {
  return [
    { title: "Payment successful | Donkey Directories" },
      ...
      <div className="w-full max-w-md rounded-2xl border-2 border-foreground bg-white shadow-[var(--shadow-md)] overflow-hidden">
        ...
        <div className="px-8 py-10 flex flex-col items-center text-center gap-6">
          ...
          <div className="relative flex items-center justify-center">
            <div className="w-24 h-24 rounded-full bg-primary border-2 border-foreground shadow-[var(--shadow-md)] flex items-center justify-center">
              <CheckCircle2 className="w-12 h-12 text-foreground" strokeWidth={2} />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mt-1">
              Your credits have been added to your account. You can start
              submitting to directories right away using the extension.
            </p>
          </div>

          {/* Credit reminder pill */}
          <div className="flex items-center gap-2 rounded-xl border-2 border-foreground bg-secondary px-4 py-2.5 shadow-[var(--shadow-sm)] text-sm font-medium">
