...
export function MockDirectoriesTable({ isAuthenticated, directoryCount }: Props) {
  ...
  function applyFilters() {
    ...
    if (draftFilters.name.trim()) params.set("name", draftFilters.name.trim());
    if (draftFilters.category !== "ALL") params.set("category", draftFilters.category);
    if (draftFilters.pricingModel === "FREE") params.set("free", "true");
    else if (draftFilters.pricingModel === "PAID") params.set("free", "false");
    if (draftFilters.linkType === "DOFOLLOW") params.set("dofollow", "true");
    else if (draftFilters.linkType === "NOFOLLOW") params.set("dofollow", "false");
              ...
              {!isAuthenticated ? (
                ...
                <>
                  ...
                  <DialogFooter className="gap-2">
                    ...
                    <Button onClick={applyFilters} disabled={isNavigating}>
                      {isNavigating ? "Loading..." : "Apply filters"}
                    </Button>
                  </DialogFooter>
                </>
              )}
